...
const ForgotPasswordPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // error surfaced via store if needed
        }
    };
    ...
    return (
        <motion.div
            ...
            className="max-w-md w-full bg-gray-800 bg-opacity-50 rounded-2xl shadow-xl overflow-hidden backdrop-filter backdrop-blur-xl"
        >
            <div className="p-8">
                ...
                {!isSubmitted ? (
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-gray-300 mb-6">
                            If an account exists for <span className="text-green-400">{email}</span>, you'll receive a
